...
const TrackPage: React.FC = () => {
  ...
  const generateTrackBreadcrumbSchema = () => {
  ...
  const schemaData = [
    { id: 'breadcrumb', data: generateTrackBreadcrumbSchema() }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head
        ...
        description="Track your HappyDeel order in real-time. Enter your tracking number to get the latest shipping updates and delivery status."
            ...
            <ClientOnly fallback={
              <div className="max-w-xl mx-auto">
                <div className="flex flex-col sm:flex-row gap-4 mb-6">
                  <div className="flex-1 px-4 py-3 border border-gray-300 rounded-lg bg-gray-100 animate-pulse"></div>
                  <div className="px-8 py-3 bg-gray-300 rounded-lg animate-pulse"></div>
                </div>
                <div className="min-h-[560px] bg-gray-100 rounded-lg animate-pulse"></div>
              </div>
            }>
              <div className="max-w-xl mx-auto">
                <div className="flex flex-col sm:flex-row gap-4 mb-6">
