...
const AboutPage: React.FC = () => {
  ...
  const generateAboutBreadcrumbSchema = () => {
  ...
  const schemaData = [
    { id: 'breadcrumb', data: generateAboutBreadcrumbSchema() }
  ];

  return (
    <div className="min-h-screen flex flex-col">
      <Head
        title="About Us - HappyDeel"
        description="Learn about HappyDeel - your premier destination for quality electronics and photography equipment. Discover our mission, values, and commitment to customer satisfaction."
