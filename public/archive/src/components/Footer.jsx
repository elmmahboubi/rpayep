    ...
    <footer className="bg-[#313a4b] text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Navigation Menu - FIXED: Use semantic Link components */}
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/#products" className="hover:text-[#0046be] transition-colors duration-300">
                  Products
                </Link>
              </li>
              <li>
                <Link to="/#featured" className="hover:text-[#0046be] transition-colors duration-300">
                  Featured
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-center">&copy; 2024 HappyDeel. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
