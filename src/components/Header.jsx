      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Desktop Navigation - FIXED: Use semantic Link components */}
            <nav className="hidden md:flex space-x-8 font-heading">
              <Link to="/" className="text-[#313a4b] hover:text-[#0046be] font-medium transition-colors duration-300">
                Home
              </Link>
              <Link to="/#products" className="text-[#313a4b] hover:text-[#0046be] font-medium transition-colors duration-300">
                Products
              </Link>
              <Link to="/#featured" className="text-[#313a4b] hover:text-[#0046be] font-medium transition-colors duration-300">
                Featured
              </Link>
              <Link to="/track" className="text-[#313a4b] hover:text-[#0046be] font-medium transition-colors duration-300">
                Track Order
              </Link>
              <Link to="/contact" className="text-[#313a4b] hover:text-[#0046be] font-medium transition-colors duration-300">
                Contact Us
              </Link>
            </nav>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              >
                ...
                {/* BULLETPROOF: Cart badge is ALWAYS in the DOM tree, but invisible if cart is empty */}
                {/* This guarantees identical structure on server and client, preventing layout shifts */}
                <ClientOnly>
                  <span 
                    className={`
                      absolute -top-2 -right-2 bg-[#0046be] text-white text-xs 
                      ...
                      <div className="divide-y">
                        {filteredProducts.map((product) => (
                          <button
                            ...
                            className="w-full text-left p-4 hover:bg-gray-50 flex items-center space-x-4 transition-colors duration-200"
                          >
                            <img
          ...
          {/* Mobile Menu - FIXED: Use semantic Link components */}
          {isMenuOpen && (
            <div className="md:hidden mt-4 py-4 border-t border-gray-200">
              <nav className="flex flex-col space-y-4 font-heading">
                <Link 
                  to="/" 
                  className="text-[#313a4b] hover:text-[#0046be] font-medium transition-colors duration-300"
